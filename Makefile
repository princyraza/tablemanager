...
SOURCES = \
	__init__.py \
	table_manager.py table_manager_dialog.py

PLUGINNAME = table_manager

PY_FILES = \
	__init__.py \
	table_manager.py table_manager_dialog.py

UI_FILES = tableManagerUi.ui tableManagerUiRename.ui tableManagerUiClone.ui tableManagerUiInsert.ui
